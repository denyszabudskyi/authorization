...
(function (window) {
    ...
    JustValidate.prototype = {
        ...
        validationFailed: function validationFailed() {
            ...
            var $firstErrorField = document.querySelector('.js-validation--error-field');
        ...
        clearErrors: function clearErrors() {
            var $elems = document.querySelectorAll('.js-validation--error-label');
            for (var i = 0, len = $elems.length; i < len; ++i) {
                $elems[i].remove();
            }

            $elems = document.querySelectorAll('.js-validation--error-field');
            for (var _i = 0, _len = $elems.length; _i < _len; ++_i) {
                $elems[_i].classList.remove('js-validation--error-field');
        ...
        hideTooltips: function hideTooltips() {
            ...
            var $elemsErrorLabel = document.querySelectorAll('.js-validation--error-label');
